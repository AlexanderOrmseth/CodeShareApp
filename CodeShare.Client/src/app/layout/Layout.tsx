...
const Layout = () => {
  return (
    <>
      <header className="bg-visual-studio-bg/70 backdrop-blur-sm sm:fixed shadow-sm z-30 w-full min-w-[320px] px-1.5 2xl:px-0 ">
        <Header />
      </header>
      <main className="mx-auto flex w-full min-w-[320px] sm:mt-12 max-w-screen-2xl grow flex-col px-1.5 pt-2 pb-12 2xl:px-0">
        <Outlet />
      </main>
